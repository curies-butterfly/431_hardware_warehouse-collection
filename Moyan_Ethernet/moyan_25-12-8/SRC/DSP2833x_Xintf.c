...
//	 GpioCtrlRegs.GPAMUX1.bit.GPIO7 = 3;  // LED_RED
//	 GpioCtrlRegs.GPAMUX1.bit.GPIO8 = 3;  // LED_BLUE
//	 GpioCtrlRegs.GPAMUX1.bit.GPIO10 = 3;  // LED_GREEN
//	 GpioCtrlRegs.GPAMUX1.bit.GPIO12 = 3;  // BEEP
